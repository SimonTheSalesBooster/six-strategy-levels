...
```
1 · PURPOSE         — why we exist          (rarely changes)
2 · VISION          — 3-year picture        (annual)
3 · GOALS           — 12-month numbers      (annual)
4 · AREAS           — ongoing standards     (always on)
5 · PROJECTS        — this month's outcomes (monthly)
6 · NEXT ACTIONS    — this week's moves     (weekly)
```

Skip a level and the system leaks:

- **No Purpose** → every pivot feels equally valid (nothing guides the no)
- **No Vision** → Goals float without context
- **No Goals** → Projects pile up without direction
- **No Areas** → Projects starve the systems that feed them
- **No Projects** → Next Actions drift into busywork
- **No Next Actions** → Projects stay aspirational
...
AI agents collapse this further. When most projects are owned by agents, the human only needs to track the few things they personally own. Everything else stays on this page, reviewed weekly.
...
It should read top-to-bottom in under 60 seconds. If it doesn't, cut words.

### Step 2 — Review it on a cadence

- **Projects**: refresh at the start of each month
- **Goals**: refresh quarterly
- **Vision**: refresh annually
- **Purpose**: refresh when everything else changes shape
...
3. **Method defined** — how it gets done, not just what
...
See [`examples/strategy-sprints.md`](examples/strategy-sprints.md) for our own filled-in version at Strategy Sprints — the real thing, not a sanitized demo.
...
If this framework helped you clarify a business, tell us — we read every note: [severino@strategysprints.com](mailto:severino@strategysprints.com).
